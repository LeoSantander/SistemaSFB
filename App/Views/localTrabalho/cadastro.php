        ...
        <div class="col-md-6">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                  <a class="btn btn-success btn-block" href="#" data-toggle="modal" data-placement="bottom" data-target="#myModal1" aria-hidden="true">+ Novo Escritório</a>
              </div>
          </div>
            <br>
            <h5>Endereço:</h5>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-dark text-white">
        <h5 class="modal-title" id="exampleModalCenterTitle">Adicionar Novo Escritório</span></h5>
      ...
      <form action="http://<?php echo APP_HOST; ?>/escritorio/salvar" method="post">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              <label for="nome">CNPJ:</label>
              <input type="text" maxlength="18" class="form-control" name="cnpj" value="<?php echo $Sessao::retornaValorFormulario('cnpj'); ?>"
                     oninvalid="this.setCustomValidity('Este campo deve estar preenchido e atender ao padrão exigido: 000.000.000-00')" onchange="try{setCustomValidity('')}catch(e){}"  pattern="[0-9]{2}.[0-9]{3}.[0-9]{3}/[0-9]{4}-[0-9]{2}"
                     onkeydown="javascript: fMasc( this, mCNPJ );">
            </div>
          </div>
